...
casper.then(function() {if ((exist('dbConfigurationFreeEditionButton')))
{ // start of code block

casper.then(function() {{techo('click //*[@id="dbConfigurationFreeEditionButton"]/button');
casper.waitFor(function check() {return check_tx('//*[@id="dbConfigurationFreeEditionButton"]/button');},
function then() {chrome.click(tx('//*[@id="dbConfigurationFreeEditionButton"]/button'));},
function timeout() {chrome.capture('D:/laragon/www/rpa-zoho-backup/zoho_download-test_error.png');
this.echo('ERROR - cannot find //*[@id="dbConfigurationFreeEditionButton"]/button').exit(); this.wait(0);});}});
...
function timeout() {chrome.capture('D:/laragon/www/rpa-zoho-backup/zoho_download-test_error.png');
this.echo('ERROR - cannot find //*[@id="dbDataLink"]/div/a').exit(); this.wait(0);});}});
...
casper.then(function() {this.echo('Download link not present');});
...
function timeout() {chrome.capture('D:/laragon/www/rpa-zoho-backup/zoho_download-test_error.png');
this.echo('ERROR - cannot find //*[@id="dbAttachmentLink"]/div/a').exit(); this.wait(0);});}});
